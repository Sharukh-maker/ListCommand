...
export interface IExportListItemsCommandSetProperties {}

const LOG_SOURCE: string = "ExportListItemsCommandSet";
...
export default class ExportListItemsCommandSet extends BaseListViewCommandSet<IExportListItemsCommandSetProperties> {
  ...
  */
  ...
  private async getViewColumns() {
    ...
    const viewId: string = this.context.pageContext.legacyPageContext.viewId
      .replace("{", "")
      .replace("}", "");
